...
# Video origine 1280 x 720, à couper en 680 x 680
## crop vers un carré (centré) de 680 x 680 --> A modifier en fonction de la video d'origine
## au milieu horizontalement mais décalé vers le bas en vertical
ffmpeg -y -i $1 -vf "crop=680:680:300:35" -ss $2 -t $3  orig1.mp4
...
[base][up] overlay=shortest=1:x=372:y=5 [tmp2];
[tmp2][right] overlay=shortest=1:x=739:y=244 [tmp3];
[tmp3][bot] overlay=shortest=1:x=372:y=483 [tmp4];
[tmp4][left] overlay=shortest=1:x=5:y=244" out.mp4
